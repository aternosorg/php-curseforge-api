...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api.curseforge.com';
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/1.3.2/PHP';
    ...
    {
        $report  = 'PHP SDK (Aternos\CurseForgeApi) Debug Report:' . PHP_EOL;
