 ...
 */
class ModLinks implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ModLinks';
    ...
    */
     ...
     * Sets wiki_url
     *
     * @param string|null $wiki_url wiki_url
     *
     * @return $this
     */
    ...
    {
        if (is_null($wiki_url)) {
            throw new InvalidArgumentException('non-nullable wiki_url cannot be null');
        }
