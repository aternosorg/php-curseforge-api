 ...
 */
class GameAssets implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GameAssets';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tile_url', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['tile_url'];
    }

    /**
     * Sets tile_url
     *
     * @param string|null $tile_url tile_url
     *
     * @return $this
     */
    public function setTileUrl(?string $tile_url): static
    {
        if (is_null($tile_url)) {
            throw new InvalidArgumentException('non-nullable tile_url cannot be null');
        }
        $this->container['tile_url'] = $tile_url;
