...
class File implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'cooking_info' => '\Aternos\CurseForgeApi\Model\CookerInfo'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cooking_info', $data ?? [], null);
    }
     ...
     * Gets cooking_info
     *
     * @return \Aternos\CurseForgeApi\Model\CookerInfo|null
     */
    public function getCookingInfo(): ?\Aternos\CurseForgeApi\Model\CookerInfo
    {
        return $this->container['cooking_info'];
    }

    /**
     * Sets cooking_info
     *
     * @param \Aternos\CurseForgeApi\Model\CookerInfo|null $cooking_info cooking_info
     *
     * @return $this
     */
    public function setCookingInfo(?\Aternos\CurseForgeApi\Model\CookerInfo $cooking_info): static
    {
        if (is_null($cooking_info)) {
            throw new InvalidArgumentException('non-nullable cooking_info cannot be null');
        }
        $this->container['cooking_info'] = $cooking_info;
