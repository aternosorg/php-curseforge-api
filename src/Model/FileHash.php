 ...
 */
class FileHash implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FileHash';
    ...
    protected static array $openAPITypes = [
        'value' => 'string',
        'algo' => '\Aternos\CurseForgeApi\Model\HashAlgo'
    ];
    ...
    */
     ...
     */
    public function getAlgo(): ?\Aternos\CurseForgeApi\Model\HashAlgo
    {
     ...
     * @return $this
     */
    public function setAlgo(?\Aternos\CurseForgeApi\Model\HashAlgo $algo): static
    {
        if (is_null($algo)) {
