...
class RatingDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RatingDetails';
    ...
    */
     ...
     * @return $this
     */
    public function setPositiveRatings(?int $positive_ratings): static
    {
     ...
     */
    public function getScore(): ?\Aternos\CurseForgeApi\Model\RatingScore
    {
     ...
     * @return $this
     */
    public function setScore(?\Aternos\CurseForgeApi\Model\RatingScore $score): static
    {
        if (is_null($score)) {
