...
class SocialLink implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SocialLink';
    ...
    */
     ...
     */
    public function getType(): ?\Aternos\CurseForgeApi\Model\SocialLinkType
    {
     ...
     * @return $this
     */
    public function setType(?\Aternos\CurseForgeApi\Model\SocialLinkType $type): static
    {
        if (is_null($type)) {
