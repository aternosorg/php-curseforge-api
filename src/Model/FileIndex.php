...
class FileIndex implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FileIndex';
    ...
    */
     ...
     */
    public function getModLoader(): ?\Aternos\CurseForgeApi\Model\ModLoaderType
    {
     ...
     * @return $this
     */
    public function setModLoader(?\Aternos\CurseForgeApi\Model\ModLoaderType $mod_loader): static
    {
