...
/**
 * GetModFilesRequestBody Class Doc Comment
 *
 * @package  Aternos\CurseForgeApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetModFilesRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetModFilesRequestBody';
    ...
    */
     ...
     * @return $this
     */
    public function setFileIds(?array $file_ids): static
    {
        if (is_null($file_ids)) {
