...
namespace Aternos\CurseForgeApi;

use BackedEnum;
use DateTimeInterface;
use DateTime;
use GuzzleHttp\Psr7\Utils;
use Aternos\CurseForgeApi\Model\ModelInterface;
...
class ObjectSerializer
{
    ...
    public static function deserialize(mixed $data, string $class, ?array $httpHeaders = null): mixed
    {
        ...
        if (is_subclass_of($class, '\BackedEnum')) {
            ...
            if (is_subclass_of($class, '\Aternos\CurseForgeApi\Model\OneOfInterface')) {
                return self::deserializeOneOf($data, $class, $httpHeaders);
            }
            if (is_subclass_of($class, '\Aternos\CurseForgeApi\Model\AnyOfInterface')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Aternos\CurseForgeApi\Model\\' . $data->{$discriminator};
