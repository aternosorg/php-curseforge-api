...
class CategoriesApi
{
     ...
     * @param  bool|null $classes_only A flag used with gameId to return only classes (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Aternos\CurseForgeApi\Model\GetCategoriesResponse, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
