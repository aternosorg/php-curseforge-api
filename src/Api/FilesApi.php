...
class FilesApi
{
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Aternos\CurseForgeApi\Model\GetFilesResponse, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    ): Request
    {
        ...
        if (isset($get_mod_files_request_body)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($get_mod_files_request_body), JSON_THROW_ON_ERROR);
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Aternos\CurseForgeApi\Model\GetModFileResponse, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
     ...
     * @param  int $mod_id The mod id the file belongs to (required)
     * @param  int $file_id The file id. (required)
     * @param  bool|null $raw Get raw changelog without things like external link redirects (optional)
     * @param  bool|null $stripped Get the changelog with all HTML tags removed (optional)
    ...
    {
        list($response) = $this->getModFileChangelogWithHttpInfo($mod_id, $file_id, $raw, $stripped, $markup, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Aternos\CurseForgeApi\Model\GetModFileChangelogResponse, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    {
        $request = $this->getModFileChangelogRequest($mod_id, $file_id, $raw, $stripped, $markup, $contentType);
    ...
    {
        return $this->getModFileChangelogAsyncWithHttpInfo($mod_id, $file_id, $raw, $stripped, $markup, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Aternos\CurseForgeApi\Model\GetModFileDownloadURLResponse, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
     ...
     * @param  bool|null $client_compatible When set to true, filter OUT any file that isn&#39;t client compatible. (optional)
    ...
    {
        list($response) = $this->getModFilesWithHttpInfo($mod_id, $index, $page_size, $game_version, $mod_loader_type, $game_version_type_id, $older_than_project_file_id, $release_types, $platform_type, $client_compatible, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Aternos\CurseForgeApi\Model\GetModFilesResponse, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    {
        $request = $this->getModFilesRequest($mod_id, $index, $page_size, $game_version, $mod_loader_type, $game_version_type_id, $older_than_project_file_id, $release_types, $platform_type, $client_compatible, $contentType);
    ...
    {
        return $this->getModFilesAsyncWithHttpInfo($mod_id, $index, $page_size, $game_version, $mod_loader_type, $game_version_type_id, $older_than_project_file_id, $release_types, $platform_type, $client_compatible, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
